#!/usr/bin/env python3
"""RISC-V table generator for asmkit (fork of riscv-opcodes' parser).

Reads riscv-opcodes (RISCV_OPCODES env var) and riscv-unified-db (RISCV_UNIFIED_DB,
optional, docs only).

Writes src/riscv/opcodes.rs, emitter.rs, instdb.rs.
